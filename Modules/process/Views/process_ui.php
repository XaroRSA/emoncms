...
<div id="processlistModal" class="modal fade keyboard modal-processlist" tabindex="-1" data-backdrop="static">
                    ...
                    <tr>
                        ...
                        <span id="type-value" style="display:none">
                                    <div class="input-group">
                                        <span class="input-group-addon value-select-label">Value</span>
                                        <input type="text" id="value-input" class="form-control" placeholder="Type value..." />
                                    </div>
                        </span>
                        
                        <span id="type-text" style="display:none">
                                    <div class="input-group">
                                        <span class="input-group-addon text-select-label">Text</span>
                        ...
                        <span id="type-input" style="display:none">
                                    <div class="input-group">
                                        <span class="input-group-addon input-select-label">Input</span>
                                        <div class="btn-group">
                        ...
                        <span id="type-schedule" style="display:none">
                                    <div class="input-group">
                                        <span class="input-group-addon schedule-select-label">Schedule</span>
                                        <div class="btn-group">
                        ...
                        <span id="type-feed"> 
                                    <div class="input-group">
                                        <span class="input-group-addon feed-select-label">Data</span>
                                        <div class="btn-group">
                                            <select id="feed-data-type" class="form-control" readonly>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon feed-select-label">Feed</span>
                                        <div class="btn-group">
                                            <select id="feed-select" class="form-control"></select>
                                            <input type="text" id="new-feed-name" class="form-control" style="width:140px" placeholder="Type feed name..." />
                                            <input type="hidden" id="new-feed-tag"/>
                                        </div>
                                    </div>
                            
                                    <div class="input-group">
                                        <span class="input-group-addon feed-engine-label"><?php echo _('Engine'); ?></span>
                                        <div class="btn-group">
